# https://github.com/WilsonWangTHU/NerveNet/blob/master/graph_util/mujoco_parser.py
import os
import numpy as np
from bs4 import BeautifulSoup as bs
import graph_nets.my_utils.init_path as init_path
import graph_nets.my_utils.logger as logger
from environments import register

__all__ = ['parse_mujoco_graph']

XML_ASSERT_DIR = os.path.join(init_path.get_base_dir(), 'environments', 'assets')
